...
export default function DeleteJarDialog({ jar, onCancel, onConfirm }: DeleteJarDialogProps) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="w-full max-w-sm rounded-xl bg-white p-6">
        <h2 className="text-base font-semibold text-gray-900">Delete Jar</h2>
        <p className="mt-2 text-sm text-gray-500">
          Are you sure you want to delete <span className="font-medium text-gray-700">{jar.name}</span>? This can&apos;t be undone.
        </p>
